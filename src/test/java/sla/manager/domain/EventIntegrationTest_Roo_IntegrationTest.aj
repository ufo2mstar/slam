...
import sla.manager.domain.EventIntegrationTest;
...
privileged aspect EventIntegrationTest_Roo_IntegrationTest {
    ...
    public void EventIntegrationTest.testFindEvent() {
        ...
        Assert.assertEquals("Find method for 'Event' returned the incorrect identifier", id, obj.getId_());
    }
    ...
    public void EventIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Event' identifier to be null", obj.getId_());
        try {
            obj.persist();
        ...
        obj.flush();
        Assert.assertNotNull("Expected 'Event' identifier to no longer be null", obj.getId_());
    }
